...
public class ReplyEngine {
    public static String[] getReply(String str) {
        ...
        if(str.contains("saldo")) {
            ...
            resultList.add("[DELAY] 1000");
            resultList.add("Apakah anda yakin transfer ke Nomor rekening 100000917, Atas nama Abdul Arfan sebesar Rp. 100.000,- ?\n\nKetik YA atau TIDAK");
        } else if(str.contains("ya")) {
            resultList.add("[DELAY] 1000");
            resultList.add("Transfer ke Nomor rekening 100000917 Atas Nama Abdul Arfan sebesar Rp. 100.000,- Berhasil\nSekarang saldo anda Rp. 4.900.000,-");
            resultList.add("[DELAY] 1000");
